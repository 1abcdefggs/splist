const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./react-markdown-CBMmIWQB.js","./lib-actehevX.js","./remark-gfm-zDqDfnnT.js"])))=>i.map(i=>d[i]);
...
- keyword: #569cd6
- string: #ce9178
`,Re=`# ✂️ SPLIST (Overview & Installation)
